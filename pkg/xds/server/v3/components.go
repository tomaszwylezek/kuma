...
func RegisterXDS(
	...
	watchdogFactory, err := xds_sync.DefaultDataplaneWatchdogFactory(rt, metadataTracker, connectionInfoTracker, reconciler, ingressReconciler, xdsSyncMetrics, meshSnapshotCache, envoyCpCtx, envoy_common.APIV3)
	if err != nil {
		return err
	}
